 ...
 * as its cwd and not the workspace it was invoked from (plan §5: "full,
 * harness-repo-scoped").
 */
...
/** True when `dir` is the nanoharness repo, so the harness is its own workspace. */
 ...
 * editing files inside the app bundle.
 */
