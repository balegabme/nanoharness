...
description: Cut a release, covering version bump, changelog, tag, and what to verify before pushing
---

# Release checklist

Only the description above is loaded into the system prompt. You are reading
this file because a task matched that line: ten skills cost ten lines until
...
4. Run the checks that gate a merge, and read the output, not the exit code.
